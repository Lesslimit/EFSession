...
namespace EFSession.Emit
{
    public class DynamicReflectionDelegateFactory : ReflectionDelegateFactory
    {
        ...
        // ReSharper disable once InconsistentNaming
        private static void GenerateCreateDefaultConstructorIL(Type type, ILGenerator generator)
        {
            if (type.IsValueType)
            {
        ...
        internal static void GenerateCreateSetFieldIL(FieldInfo fieldInfo, ILGenerator generator)
        {
            ...
            generator.Emit(!fieldInfo.IsStatic ? OpCodes.Stfld : OpCodes.Stsfld, fieldInfo);
            generator.Return();
        }
